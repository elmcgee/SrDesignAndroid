...
public class BluetoothActivity extends AppCompatActivity {
    ...
    public void onButtonTouchClick(View v){
        if(v.getId() == R.id.button_touchScreen){
            Intent intent = new Intent(BluetoothActivity.this, TouchScreenActivity.class);
            startActivity(intent);
    ...
    private void scanForBluetoothDevices(){
        ...
        Intent intent = new Intent(BluetoothActivity.this, FoundBTDevices.class);
        startActivity(intent);
    }


}//end of BluetoothActivity Class
